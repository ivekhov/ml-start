...
step over - построчное выполнение , но без проваливания во внутренние функции, встречающиеся в коде
step into - более глубокое проваливание внутрь исполнения функций, которые встречаются в коде по мере выполнения
step out  - проиграть функцию без построчного дебага внутри функции
